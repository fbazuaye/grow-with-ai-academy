...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "AI Mastery Academy" },
      { property: "og:description", content: "Practical AI training for real outcomes — sales, jobs, content, productivity, income." },
